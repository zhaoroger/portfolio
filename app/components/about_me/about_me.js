      ...
      <div className={styles.divider}>
        <div className={styles.text_section}>
          ...
          <p className={styles.para}>
            ...
            I am a fourth-year Computer Science student at the University of Toronto, specializing in Software Engineering. I am a quick learner who is always eager and interested in exploring new technologies and concepts. 
